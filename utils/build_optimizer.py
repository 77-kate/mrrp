...
def build_optimizer(opts, model, printer=print):
    ...
    if opts.finetune: # default false
        params = [
    ...
    if opts.optim == 'sgd':
        ...
        optimizer = optim.Adam(
            ...
            lr=opts.lr,
            betas=(beta1, beta2),
            weight_decay=opts.weight_decay, # 4e-06 default
            eps=1e-9)
...
def get_optimizer_opts(parser):
    ...
    group.add_argument('--optim', default='adam', type=str, help='Optimizer')
    ...
    group.add_argument('--lr', default=1e-5, type=float, help='Initial learning rate for the optimizer')
