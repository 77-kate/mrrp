...
class Statistics(object):
    ...
    def __init__(self, printer=print):
        ...
        self.eps = 1e-9
        self.counter = 0
        self.c_idx_counter = 0
        self.printer = printer

    def update(self, loss, c_index):
        '''
        :param loss: Loss at ith time step
        :param c_index: C_index at ith time step
        :return:
        '''
        self.loss += loss
        self.counter += 1
        if c_index:
            ...
            self.c_idx_counter += 1
        

    def __str__(self):
        return 'Loss: {}'.format(self.loss)

    def avg_c_idnex(self):
        '''
        :return: Average Accuracy
        '''
        return self.c_index / self.c_idx_counter
